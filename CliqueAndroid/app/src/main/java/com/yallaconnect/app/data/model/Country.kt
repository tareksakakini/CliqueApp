...
data class Country(
    ...
    val sanitizedDialCode: String get() =
        if (dialCode.any { it.isDigit() }) "+" + dialCode.filter { it.isDigit() } else dialCode
    ...
    companion object {
        ...
        val default: Country = all.firstOrNull { it.code == "US" } ?: all.first()
